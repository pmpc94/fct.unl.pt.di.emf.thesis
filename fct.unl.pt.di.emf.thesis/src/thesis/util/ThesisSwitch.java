 ...
 * @generated
 */
public class ThesisSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ThesisPackage.DRIVE: {
				...
				if (result == null) result = caseBaseClass(drive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ThesisPackage.FOLDER: {
				Folder folder = (Folder)theEObject;
				T result = caseFolder(folder);
				if (result == null) result = caseFile(folder);
				if (result == null) result = caseBaseClass(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ThesisPackage.SHORTCUT: {
				Shortcut shortcut = (Shortcut)theEObject;
				T result = caseShortcut(shortcut);
				if (result == null) result = caseFile(shortcut);
				if (result == null) result = caseBaseClass(shortcut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ThesisPackage.SYNC: {
				Sync sync = (Sync)theEObject;
				T result = caseSync(sync);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ThesisPackage.FILE: {
				File file = (File)theEObject;
				T result = caseFile(file);
				if (result == null) result = caseBaseClass(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
