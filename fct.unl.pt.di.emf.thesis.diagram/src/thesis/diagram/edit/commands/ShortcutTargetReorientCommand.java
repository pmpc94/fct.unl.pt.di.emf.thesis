...
public class ShortcutTargetReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ShortcutTargetReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ThesisBaseItemSemanticEditPolicy.getLinkConstraints().canExistShortcutTarget_4002(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ThesisBaseItemSemanticEditPolicy.getLinkConstraints().canExistShortcutTarget_4002(getOldSource(),
				getNewTarget());
	}
