...
public class SyncReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof Search)) {
			return false;
		}
		Search container = (Search) getLink().eContainer();
		return ThesisBaseItemSemanticEditPolicy.getLinkConstraints().canExistSync_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Search container = (Search) getLink().eContainer();
		return ThesisBaseItemSemanticEditPolicy.getLinkConstraints().canExistSync_4001(container, getLink(), source,
				getNewTarget());
	}
