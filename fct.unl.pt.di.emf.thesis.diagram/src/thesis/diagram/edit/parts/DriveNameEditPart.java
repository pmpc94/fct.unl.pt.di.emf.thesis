 ...
 * @generated
 */
public class DriveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ThesisParserProvider.getParser(ThesisElementTypes.Drive_2001, getParserElement(),
					ThesisVisualIDRegistry.getType(thesis.diagram.edit.parts.DriveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
