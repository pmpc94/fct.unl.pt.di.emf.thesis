...
import thesis.diagram.edit.commands.ThesisCreateShortcutDecorationsCommand;
import thesis.diagram.edit.policies.SearchCanonicalEditPolicy;
import thesis.diagram.edit.policies.SearchItemSemanticEditPolicy;
import thesis.diagram.part.ThesisVisualIDRegistry;

/**
 * @generated
 */
public class SearchEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "Thesis"; //$NON-NLS-1$
	...
	* @generated
	*/
	public SearchEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SearchItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new SearchCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new ThesisCreateShortcutDecorationsCommand(getEditingDomain(),
