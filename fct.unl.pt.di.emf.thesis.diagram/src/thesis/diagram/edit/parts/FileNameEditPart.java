...
public class FileNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ThesisParserProvider.getParser(ThesisElementTypes.File_3004, getParserElement(),
					ThesisVisualIDRegistry.getType(thesis.diagram.edit.parts.FileNameEditPart.VISUAL_ID));
		}
		return parser;
	}
