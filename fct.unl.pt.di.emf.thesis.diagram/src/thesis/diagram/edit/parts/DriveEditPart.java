...
import thesis.diagram.edit.policies.DriveItemSemanticEditPolicy;
...
public class DriveEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DriveItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DriveNameEditPart) {
			((DriveNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDriveLabelFigure());
			return true;
		}
		if (childEditPart instanceof DriveDriveContentsCompartmentEditPart) {
			...
			pane.add(((DriveDriveContentsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DriveDriveContentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDriveContentsCompartmentFigure();
			pane.remove(((DriveDriveContentsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ThesisVisualIDRegistry.getType(DriveNameEditPart.VISUAL_ID));
	}
