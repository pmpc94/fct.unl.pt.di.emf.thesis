...
public class FolderNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ThesisParserProvider.getParser(ThesisElementTypes.Folder_3002, getParserElement(),
					ThesisVisualIDRegistry.getType(thesis.diagram.edit.parts.FolderNameEditPart.VISUAL_ID));
		}
		return parser;
	}
