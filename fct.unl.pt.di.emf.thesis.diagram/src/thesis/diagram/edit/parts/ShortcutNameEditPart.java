...
public class ShortcutNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ThesisParserProvider.getParser(ThesisElementTypes.Shortcut_3003, getParserElement(),
					ThesisVisualIDRegistry.getType(thesis.diagram.edit.parts.ShortcutNameEditPart.VISUAL_ID));
		}
		return parser;
	}
