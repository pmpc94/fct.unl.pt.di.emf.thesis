...
import thesis.diagram.edit.policies.ThesisTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DriveName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ThesisTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ThesisElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ThesisParserProvider.getParser(ThesisElementTypes.Drive_3001, getParserElement(),
					ThesisVisualIDRegistry.getType(thesis.diagram.edit.parts.DriveName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ThesisEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
