...
import thesis.diagram.edit.policies.FolderItemSemanticEditPolicy;
...
public class FolderEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FolderNameEditPart) {
			((FolderNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureFolderLabelFigure());
			return true;
		}
		if (childEditPart instanceof FolderFolderContentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFolderContentsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((FolderFolderContentsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FolderFolderContentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFolderContentsCompartmentFigure();
			pane.remove(((FolderFolderContentsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ThesisVisualIDRegistry.getType(FolderNameEditPart.VISUAL_ID));
	}
	...
	public class FolderFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureFolderLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));
