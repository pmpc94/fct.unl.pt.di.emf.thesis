...
import search.provider.BaseClassItemProvider;

import thesis.File;
import thesis.ThesisPackage;

/**
 * This is the item provider adapter for a {@link thesis.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider extends BaseClassItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ThesisPackage.Literals.FILE__NAME,
				 true,
				 false,
				 false,
