...
/**
 * This is the item provider adapter for a {@link thesis.Search} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SearchItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ThesisPackage.Literals.SEARCH__DRIVES);
			childrenFeatures.add(ThesisPackage.Literals.SEARCH__SYNCS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ThesisPackage.Literals.SEARCH__DRIVES,
				 ThesisFactory.eINSTANCE.createDrive()));

		newChildDescriptors.add
			(createChildParameter
				(ThesisPackage.Literals.SEARCH__SYNCS,
				 ThesisFactory.eINSTANCE.createSync()));
	}
